...
((	otherlv_0='@name' 
    {
    	newLeafNode(otherlv_0, grammarAccess.getMetaDataDeclarationAccess().getNameKeyword_0_0());
    }
(
(
		lv_name_1_0=RULE_STRING
		{
			newLeafNode(lv_name_1_0, grammarAccess.getMetaDataDeclarationAccess().getNameSTRINGTerminalRuleCall_0_1_0()); 
		}
		{
	        if ($current==null) {
    ...
    {
    	newLeafNode(otherlv_2, grammarAccess.getMetaDataDeclarationAccess().getVersionKeyword_1_0());
    }
(
(
		{ 
    ...
    {
    	newLeafNode(otherlv_4, grammarAccess.getMetaDataDeclarationAccess().getDescriptionKeyword_2_0());
    }
(
(
		lv_description_5_0=RULE_STRING
		{
			newLeafNode(lv_description_5_0, grammarAccess.getMetaDataDeclarationAccess().getDescriptionSTRINGTerminalRuleCall_2_1_0()); 
		}
		{
	        if ($current==null) {
	            $current = createModelElement(grammarAccess.getMetaDataDeclarationRule());
    ...
    {
    	newLeafNode(otherlv_6, grammarAccess.getMetaDataDeclarationAccess().getAuthorKeyword_3_0());
    }
(
(
		lv_author_7_0=RULE_STRING
		{
			newLeafNode(lv_author_7_0, grammarAccess.getMetaDataDeclarationAccess().getAuthorSTRINGTerminalRuleCall_3_1_0()); 
		}
		{
	        if ($current==null) {
	            $current = createModelElement(grammarAccess.getMetaDataDeclarationRule());
    ...
    {
    	newLeafNode(otherlv_8, grammarAccess.getMetaDataDeclarationAccess().getEmailKeyword_4_0());
    }
(
(
		{ 
    ...
    {
    	newLeafNode(otherlv_10, grammarAccess.getMetaDataDeclarationAccess().getOrganizationKeyword_5_0());
    }
(
(
		lv_organization_11_0=RULE_STRING
		{
			newLeafNode(lv_organization_11_0, grammarAccess.getMetaDataDeclarationAccess().getOrganizationSTRINGTerminalRuleCall_5_1_0()); 
		}
		{
	        if ($current==null) {
	            $current = createModelElement(grammarAccess.getMetaDataDeclarationRule());
...
))?(	otherlv_12='@publication' 
    {
    	newLeafNode(otherlv_12, grammarAccess.getMetaDataDeclarationAccess().getPublicationKeyword_6_0());
    }
(
(
		lv_publication_13_0=RULE_STRING
		{
			newLeafNode(lv_publication_13_0, grammarAccess.getMetaDataDeclarationAccess().getPublicationSTRINGTerminalRuleCall_6_1_0()); 
		}
		{
	        if ($current==null) {
	            $current = createModelElement(grammarAccess.getMetaDataDeclarationRule());
    ...
    {
    	newLeafNode(otherlv_14, grammarAccess.getMetaDataDeclarationAccess().getDateKeyword_7_0());
    }
(
(
		lv_date_15_0=RULE_STRING
		{
			newLeafNode(lv_date_15_0, grammarAccess.getMetaDataDeclarationAccess().getDateSTRINGTerminalRuleCall_7_1_0()); 
		}
		{
	        if ($current==null) {
	            $current = createModelElement(grammarAccess.getMetaDataDeclarationRule());
