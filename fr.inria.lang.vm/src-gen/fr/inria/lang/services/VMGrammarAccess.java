...
public class VMGrammarAccess extends AbstractGrammarElementFinder {
	...
	public class FeatureElements extends AbstractParserRuleElementFinder {
		...
		//	"@NotDecideable")?) / ** mao: notTranslatable means that the the interpreter 
		...
		//	optional?="?"? ("cloneBetween" min=Integer "and" max=Integer | "[" min=Integer ".." max=Integer "]")? name=ID;
		public ParserRule getRule() { return rule; }
	...
	public class AttrDefElements extends AbstractParserRuleElementFinder {
		...
		//		 * / AttrDef:
		//	(notTranslatable?=("@NT" | "@NotTranslatable")? runTime?=("@RT" | "@RunTime")? notDecidable?=("@ND" |
		//	"@NotDecideable")?) (basicAttrDef=BasicAttrDef //(notTranslatable?=('@NotTranslatable'|'@NT') & runTime?=('@RunTime'|'@RT') & notDecidable?='@NotDecideable'|"@ND")
		...
		//basicAttrDef=BasicAttrDef //(notTranslatable?=('@NotTranslatable'|'@NT') & runTime?=('@RunTime'|'@RT') & notDecidable?='@NotDecideable'|"@ND")
		//| enumAttrDef=EnumAttrDef
		public Alternatives getAlternatives_1() { return cAlternatives_1; }
	...
	public class IntegerAttrDefUnboundedElements extends AbstractParserRuleElementFinder {
		...
		////mao 5/2/2014, delta must not be considered in unbounded attributes definitions.
		//IntegerAttrDefUnbounded:
